...
void SandBox2D::OnUpdate(Athena::Time frameTime)
{
...

	{
		...
		Athena::Renderer2D::DrawQuad({ 0.2f, -0.5f }, { 0.5f, 0.75f }, { 1.f, 1.f, 1.f });
		//Athena::Renderer2D::DrawRotatedQuad({ 0.0f, 0.0f, 0.1f }, { 10.f, 10.f }, 0.5f, m_CheckerBoard, 10, Athena::Color(1.f, 0.8f, 0.8f));
